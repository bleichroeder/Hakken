...
namespace Hakken.Device.HDHomeRun
{
    ...
    /// Remote device info.
    /// </summary>
    public class RemoteHDHomeRunDeviceInfo : RemoteDeviceInfoBase
    {
        ...
        public RemoteHDHomeRunDeviceInfo(IPAddress ipAddress)
        {
            _deviceIP = ipAddress;
        ...
        public RemoteHDHomeRunDeviceInfo(IDeviceInfo genericDeviceInfo)
        {
