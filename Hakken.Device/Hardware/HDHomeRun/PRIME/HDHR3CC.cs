...
{
    public class HDHR3CC : HDHomeRunHardwareBase
    {
        public override HardwareModel HardwareModel => HardwareModel.PRIME;

        public override string ParentModelName => "HDHomeRun PRIME";

        public override string ModelNumber => "HDHR3-CC";
        ...
        public override string PowerSupply => @"5Volt 2.5Amp regulated power adapter (higher Amp rating ok)
