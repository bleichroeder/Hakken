...
namespace Hakken.Device.Hauppauge
{
    ...
    /// Remote device info.
    /// </summary>
    public class LocalHauppaugeDeviceInfo : LocalDeviceInfoBase
    {
        ...
        public LocalHauppaugeDeviceInfo(IPAddress ipAddress)
        {
            _deviceIP = ipAddress;
        ...
        public LocalHauppaugeDeviceInfo(IDeviceInfo genericDeviceInfo)
        {
