...
namespace Hakken.Device.Hauppauge
{
    /// <summary>
    /// Remote device info.
    /// </summary>
    public class RemoteHauppaugeDeviceInfo : RemoteDeviceInfoBase
    {
        ...
        public RemoteHauppaugeDeviceInfo(IPAddress ipAddress)
        {
            _deviceIP = ipAddress;
        ...
        /// <summary>
        /// Converts a generic device info object to a RemoteHDHomeRun device info object.
        /// </summary>
        /// <param name="genericDeviceInfo"></param>
        public RemoteHauppaugeDeviceInfo(IDeviceInfo genericDeviceInfo)
        {
