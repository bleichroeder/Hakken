...
namespace Hakken.Tuner.Model
{
    ...
    /// TunerInfo object.
    /// </summary>
    public partial class LocalTunerInfo : ITunerInfo
    {
        /// <summary>
        /// Tuner URI format.
        /// </summary>
        ...
        public LocalTunerInfo(IPAddress deviceIP, int tunerNumber, string deviceID)
        {
            DeviceID = deviceID;
        ...
        /// </summary>
        public TunerLocation Location => TunerLocation.Local;
